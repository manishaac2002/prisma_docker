...
CREATE TABLE `House` (
    ...
    `bulitById` VARCHAR(191) NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `House` ADD CONSTRAINT `House_bulitById_fkey` FOREIGN KEY (`bulitById`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
